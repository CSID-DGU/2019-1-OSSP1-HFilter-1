...
if select=="예" or select=="Yes" or select=="yes"    or select=="1" or select=="o" or select=="ok":
    num_withID.makeHistogram_IDkorean(path_men, "페이지", "좋아요")
    num_withID.makeHistogram_IDkorean(path_women, "페이지", "좋아요")
    num_withID.makeHistogram_IDkorean(path_union, "페이지", "좋아요")
